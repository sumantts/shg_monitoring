	...
	**************/
	...
	$all_samsad1 = '[
		...
		$social_activities1 = '[
			{
				"id": "1",
				"name": "টয়লেট সচেতনতা কর্মসূচী"
			},{
				"id": "2",
				"name": "ধোঁয়াহীন রান্নার চুলা"
			},{
				"id": "3",
				"name": "পরিবার পরিকল্পনা কর্মসূচি"
			},{
				"id": "4",
				"name": "পুষ্টি বাগান"
			},{
				...
				"id": "6",
				"name": "ক্যান্সার শনাক্তকরণ ক্যাম্প"
			},{
				"id": "7",
				"name": "থ্যালাসেমিয়া ক্যাম্প"
			},{
				"id": "8",
				"name": "উত্পাদনকারী গ্রুপ পরিদর্শন"
			}
		]';
		$social_activities = json_decode($social_activities1);
?>

                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-4 col-form-label text-danger">Member ID *</label>
                            <div class="col-sm-8">
                              <input type="hidden" name="Staff_Id" id="Staff_Id" value="<?=$_SESSION["Staff_Id"]?>" />
                              <input type="hidden" name="User_Id" id="User_Id" value="<?=$_SESSION["User_Id"]?>" />
                              <input type="tel" id="member_Id" class="form-control" />
							  <span class="col-form-label  text-danger" id="member_Id_error" style="font-size: 12px;"></span>
							  <span class="col-form-label  text-success" id="member_Id_success" style="font-size: 12px;"></span>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                          <button type="button" id="check_member_Id" class="btn btn-inverse-success btn-fw">Check</button>
                          </div>
                        </div>
                      </div>
                      ...
                      <table class="table table-bordered">
                        <thead>
                          <tr style="text-align: center;">
                            <th scope="col" colspan="2" id="text_org_name"> </th>
                          </tr>
                          <tr style="text-align: center;">
                            <th scope="col" colspan="2">Collection Receipt</th>
                          </tr>
                          <tr style="text-align: center;">
                            <th scope="col" colspan="2" id="text_collection_date"> </th>
                          </tr>
                          <tr style="text-align: center;">
                            <th scope="col" colspan="2" id="text_mem_name"> </th>
                          </tr>
                        </thead>
